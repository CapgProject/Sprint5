...
public class OtmApplicationTests {
	...
	public void testAddQuestionUrl() {
		Question question = restTemplate.getForObject("/addquestion", Question.class);
		assertThat(question);
	}
	...
	@Test
	public void testUpdateTestUrl() {
		OnlineTest onlineTest = restTemplate.getForObject("/updatetest", OnlineTest.class);
		assertThat(onlineTest);
	}

	@Test
	public void testUpdateQuestionUrl() {
		Question question = restTemplate.getForObject("/updateuser", Question.class);
		assertThat(question);
	}
	...
	public void testRemoveQuestionUrl() {
		Question question = restTemplate.getForObject("/removetestsubmit", Question.class);
		assertThat(question);
	}

	@Test
	public void testShowUsersUrl() {
		List<User> userList = restTemplate.getForObject("/showallusers", List.class);
		assertThat(userList);
	...
	public void testShowTestsUrl() {
		List<OnlineTest> onlineTestList = restTemplate.getForObject("/showalltests", List.class);
		assertThat(onlineTestList);

	}

// @Test
	public void checkUserData() {
		assertEquals(7, onlineTestService.getUsers().size());

	}

	@Test
	public void checkTestData() {
		assertEquals(7, onlineTestService.getTests().size());
	}
	...
	@Test
	public void answerQuestionUnitTest() throws UserException {
		OnlineTest test = onlineTestService.searchTest(Long.valueOf(2));
		Question question = onlineTestService.showQuestion(test, Long.valueOf(3));
		assertEquals(new Boolean(true), onlineTestService.answerQuestion(test, question, 2));
