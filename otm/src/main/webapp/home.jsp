	...
	$(function() {
		...
		function check_password_register() {
			...
			if (pattern.test($("#userpassword").val())) {
				...
				$("#password_error")
						.html(
								"Password should contain at least one upper case character, one lower case character, one numeric character, one special character and length should be at least eight characters");
				$("#password_error").show();
...
<body>
			...
			<div id="logo" class="pull-left" style="width: 100%">
				...
				<nav id="nav-menu-container">
					...
					<ul class="nav nav-menu nav-navbar nav-right">
						<li><a class="button" href="" data-toggle="modal"
							data-target="#LoginForm"><i class="fa fa-sign-in"></i>&nbsp;Login</a></li>
					</ul>
				</nav>
			</div>
	</header>
	...
	<section id="hero" class="home">
		<div class="hero-container">
			...
			<a href="" class="btn-get-started" data-toggle="modal"
				data-target="#RegisterForm">Register Now</a>
		</div>
	</section>
	<!-- #hero -->
	...
	<main id="main">
			...
			<div class="container">
				<div class="row about-container">
					...
					<div class="col-lg-6 content order-lg-1 order-2">
						...
						<p>A global leader in consulting, technology services and
							digital transformation, Capgemini is at the forefront of
							innovation to address the entire breadth of clients’
		...
		<section id="contact">
			<div class="container wow fadeInUp">
				<div class="section-header">
					...
					<p class="section-description">You can get in touch with us in
						...
						<div class="modal-body mx-4">
							...
							<div class="md-form mb-5">
								...
								<label data-error="wrong" data-success="right" for="Form-email1">Your
									Username</label> <span id="username_error_message" class="error"></span>
							</div>

							<div class="md-form pb-3">
								<input id="password" name="password" type="password" class="form-control" />
								<label data-error="wrong" data-success="right" for="Form-pass1">Your
									password</label> <span id="password_error_message" class="error"></span>
		...
		<div class="modal fade" id="RegisterForm" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<!--Content-->
				<fo:form id="register" action="addusersubmit" method="post"
					modelAttribute="user">
					<div class="modal-content form-elegant">
						<!--Header-->
						<div class="modal-header text-center">
						...
						<div class="modal-body mx-4">
							<!--Body-->
							<div class="md-form mb-5">
								<fo:input id="usernametwo" type="text" path="userName"
									class="form-control" />
								<label data-error="wrong" data-success="right" for="Form-email1">Your
									Username</label> <span id="username_error" class="error"></span>
							</div>

							<div class="md-form pb-3">
								<fo:input id="userpassword" type="password" path="userPassword"
									class="form-control" />
								<label data-error="wrong" data-success="right" for="Form-pass1">Your
									password</label> <span id="password_error" class="error"></span>
							</div>
							<div class="text-center mb-3">
								<button type="submit"
									class="btn blue-gradient btn-block btn-rounded z-depth-1a">Register</button>
							</div>
							<p
								class="font-small dark-grey-text text-right d-flex justify-content-center mb-3 pt-2">
								or Register with:</p>
